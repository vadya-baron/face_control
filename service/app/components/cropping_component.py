...
class CroppingComponent:
        ...
        if len(faces) == 0:
            ...
            for x, y, width, height in faces:
                if self._filling:
                    ...
                    if self.__is_filling(original_image, cropped_image, self._filling):
    ...
    @staticmethod
    def __is_filling(original_image=0, cropped_image=0, filling=0) -> bool:
